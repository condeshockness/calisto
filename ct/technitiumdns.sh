#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/condeshockness/calisto/main/misc/build.func)
# Copyright (c) 2021-2025 tteck
# Author: tteck (tteckster)
# License: MIT | https://github.com/condeshockness/calisto/raw/main/LICENSE
